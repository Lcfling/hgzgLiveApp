...
import com.weitao.vcloud.live.nim.adapter.MemberAdapter;
...
public class LiveRoomInfoFragment extends BaseFragment {
    ...
    public static int online_members;
    ...
    public int getNewMembers(List<ChatRoomMember> members){
        memberAdapter.updateMember(members);
        online_members = members.size();
