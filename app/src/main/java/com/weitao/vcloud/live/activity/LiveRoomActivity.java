...
import com.weitao.vcloud.live.fragment.AudienceFragment;
import com.weitao.vcloud.live.fragment.CaptureFragment;
import com.weitao.vcloud.live.fragment.ChatRoomMessageFragment;
import com.weitao.vcloud.live.fragment.ChatRoomMsgListPanel;
import com.weitao.vcloud.live.fragment.LiveRoomInfoFragment;
import com.weitao.vcloud.live.liveStreaming.CapturePreviewController;
import com.weitao.vcloud.live.liveStreaming.PublishParam;
import com.weitao.vcloud.live.nim.NimContract;
import com.weitao.vcloud.live.nim.NimController;
import com.weitao.vcloud.live.nim.constant.GiftType;
import com.weitao.vcloud.live.nim.session.input.InputConfig;
import com.weitao.vcloud.live.server.DemoServerHttpClient;
import com.weitao.vcloud.live.nim.session.extension.GiftAttachment;
import com.weitao.vcloud.live.nim.session.extension.LikeAttachment;
import com.weitao.vcloud.live.util.ScreenUtil;
import com.weitao.vcloud.live.fragment.LiveBottomBar;
import com.weitao.vcloud.live.util.VcloudFileUtils;
...
public class LiveRoomActivity extends BaseActivity implements NimContract.Ui{
    ...
    public static void startAudience(Context context, String roomId, String url, boolean isSoftDecode) {
        ...
        LogUtil.e("LiveRoomActivity", "startAudience()");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        LogUtil.e("LiveRoomActivity", "onCreate()");
    ...
    protected int getContentView() {
        LogUtil.e("LiveRoomActivity", "getcontentview()");
    ...
    protected void initView() {
        //应用运行时，保持屏幕高亮，不锁屏
        LogUtil.e("LiveRoomActivity", "initView()");
     ...
     * 正常开始直播
     */
    public void normalStartLive() {
        //主播发送离开房间请求
        if(!isAudience) {
            DemoServerHttpClient.getInstance().anchorAction(1, new DemoServerHttpClient.DemoServerHttpCallback<Void>() {
                @Override
