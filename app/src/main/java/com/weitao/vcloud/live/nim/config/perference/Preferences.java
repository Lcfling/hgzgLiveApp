package com.weitao.vcloud.live.nim.config.perference;
...
public class Preferences {
    ...
    private static final String KEY_USER_APPKEY = "appkey";
    ...
    public static void saveUserappkey(String appkey) {
        saveString(KEY_USER_APPKEY, appkey);
    }
    public static String getUserappkey() {
        return getString(KEY_USER_APPKEY);
    }
